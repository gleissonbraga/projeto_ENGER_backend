...
namespace ENGER.Application.UseCases.Employee.Active
{
    public class ActiveEmployeeUseCase
    {
        private readonly IEmployeeRepository _repository;

        public ActiveEmployeeUseCase(IEmployeeRepository repository)
        {
        ...
        public async Task<Domain.Entities.Employee> ExecuteAsync(int companyId, int employeeId)
        {
            ...
            await _repository.ActiveEmployee(objEmployee);
