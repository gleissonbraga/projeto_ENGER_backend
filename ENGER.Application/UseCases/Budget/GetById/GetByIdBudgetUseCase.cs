...
{
    public class GetByIdBudgetUseCase
    {
        public readonly IBudgetRepository _repository;
        public readonly ICompanyRepository _companyRepository;
        public readonly IClientRepository _clientRepository;

        public GetByIdBudgetUseCase(IBudgetRepository repository, ICompanyRepository companyRepository)
        {
            _repository = repository;
            _companyRepository = companyRepository;
        }

        public async Task<BudgetResponseDTO> ExecuteAsync(int intbudgetId, int companyId)
        {
            ...
            Domain.Entities.Budget objBudgetResponse = await _repository.GetByIdAsync(intbudgetId, companyId);
